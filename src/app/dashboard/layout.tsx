    ...
    <div className="flex min-h-screen bg-neutral-50">
      <aside className="w-64 shrink-0 border-r border-neutral-200 bg-white flex flex-col">
        ...
        <div className="p-4 border-t border-neutral-100 space-y-2">
          ...
          {(!process.env.NEXT_PUBLIC_ADMIN_EMAIL || ctx.user.email === process.env.NEXT_PUBLIC_ADMIN_EMAIL) && (
            <Link href="/admin/clients" className="flex items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-indigo-50 text-indigo-600 font-medium">
