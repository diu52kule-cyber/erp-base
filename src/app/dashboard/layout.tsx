...
export default async function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  // Trial expired / suspended / cancelled → hard lock to the paywall.
    ...
    <div className="flex min-h-screen bg-neutral-50">
      <aside className="w-64 shrink-0 border-r border-neutral-200 bg-white flex flex-col">
        ...
        <div className="p-4 border-t border-neutral-100 space-y-2">
          ...
          <Link href="/dashboard/settings/preferences" className="flex items-center gap-2 rounded-md px-3 py-2 text-sm hover:bg-neutral-100 text-neutral-600">
