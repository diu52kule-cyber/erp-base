  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-3">
        <Link href="/dashboard/billing/recurring" className="text-sm text-neutral-500 hover:text-neutral-900">← Back</Link>
        <h1 className="text-2xl font-semibold">New Recurring Invoice</h1>
      </div>
      <RecurringForm defaultGst={cfg.defaultGst} products={(products ?? []) as never} contacts={(contacts ?? []) as never} />
    </div>
  );
}
